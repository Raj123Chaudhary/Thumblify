...
const stylePrompts = {
  ...
  "Tech/Futuristic":
    "futuristic thumbnail, sleek modern design, digital UI elements, glowing accents, holographic effects",
  Minimalist:
    "minimalist thumbnail, clean layout, simple shapes, limited color palette",
  Photorealistic:
    "photorealistic thumbnail, ultra-realistic lighting, natural skin tones, DSLR-style photography",
  Illustrated:
    "illustrated thumbnail, custom digital illustration, stylized characters, bold outlines",
} as const;
...
export const color_scheme_description = {
  ...
  neon: "neon glowing colors with bright cyan, magenta, electric blue, and high contrast on dark backgrounds",
