...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="What you get" text3="Create stunnig thumnails that gets clicks , without the hassle." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our Ai understands what makes a video go viral and designs thumnails accordingly
                </motion.p>
