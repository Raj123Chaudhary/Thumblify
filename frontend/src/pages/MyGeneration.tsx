      ...
      <div className="mt-32 min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-zinc-400 mt-1">
            View and manage all your AI generated thumnails
          </p>
        </div>
        {/* LOading  */}
        {loading && (
          // skelton for my generation page
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {Array.from({ length: 6 }).map((_, i) => (
              <div
                key={i}
                className="rounded-2xl bg-white/60 border border-white/10  animate-pulse  h-[260px]"
              >
                {" "}
              </div>
            ))}
        ...
        {!loading && thumbnails.length === 0 && (
          <div className="text-center py-24">
            ...
            <p className="text-sm text-zinc-400 mt-2">
              Generate your first thumbnails to see it here
            </p>
          </div>
        )}
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <Link
                      target="_blank"
                      to={`/preview?thumnail_url=${thumb.image_url}&title=${thumb.title}`}
                    >
